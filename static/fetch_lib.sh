...
then
    if ! curl -sfL https://raw.githubusercontent.com/XSR1/Nextcloud-VM/master/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/XSR1/Nextcloud-VM/master/lib.sh -o /var/scripts/lib.sh
fi
